...
public class MainViewViewModel : ViewModelBase
{
    ...
    private bool _ignoreSetListBoxColor;
    private Color _listBoxColor;
    private bool _useCustomAccentColor;

    public MainViewViewModel(IConfiguration configuration)
    {
        ...
        PredefinedColors = GetPredefColors();
    }

    public List<Color> PredefinedColors { get; }
    public string CurrentVersion => _configuration["Version"];
    public string WebSite => _configuration["Website"];

    public string[] AppThemes { get; } =
    {
        FluentAvaloniaTheme.LightModeString, FluentAvaloniaTheme.DarkModeString,
    ...
    public string CurrentAppTheme
    {
        ...
        set
        {
            if (!RaiseAndSetIfChanged(ref _currentAppTheme, value)) return;
    ...
    public bool UseCustomAccent
    {
        ...
        set
        {
            if (!RaiseAndSetIfChanged(ref _useCustomAccentColor, value)) return;
    ...
    public Color CustomAccentColor
    {
        ...
        set
        {
            if (!RaiseAndSetIfChanged(ref _customAccentColor, value)) return;
    ...
    {
        if (_currentAppTheme == args.NewTheme) return;

        _currentAppTheme = args.NewTheme;
        RaisePropertyChanged(nameof(CurrentAppTheme));
    }

    private List<Color> GetPredefColors()
    {
